...
const Icon = {
  home: (p: IconProps) => (
    <svg className={p.className} fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.4}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2 6.5 8 2l6 4.5V13a1 1 0 0 1-1 1h-2.5v-3.5h-3V14H3a1 1 0 0 1-1-1V6.5Z" />
    </svg>
  ),
  ...
  settings: (p: IconProps) => (
    <svg className={p.className} fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.4}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 1.5v1.6M8 12.9v1.6M3.4 3.4l1.1 1.1M11.5 11.5l1.1 1.1M1.5 8h1.6M12.9 8h1.6M3.4 12.6l1.1-1.1M11.5 4.5l1.1-1.1" />
    </svg>
  ),
  history: (p: IconProps) => (
    <svg className={p.className} fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={1.4}>
  ...
  collapse: (p: IconProps) => (
    <svg className={p.className} fill="none" viewBox="0 0 20 20" stroke="currentColor" strokeWidth={1.5}>
  ...
  globe: (p: IconProps) => (
    <svg className={p.className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  if (collapsed) {
    return (
      <div className="flex h-[26px] w-full items-center justify-center">
        <span className="text-xl font-extrabold tracking-tight text-white">s</span>
      </div>
    );
  }
  return (
...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`${collapsed ? "w-[72px]" : "w-60"} flex h-full flex-col justify-between border-r border-subtle bg-base transition-[width] duration-200`}
    >
      {/* Logo + collapse */}
      <div>
      ...
      >
        <a href="https://x.com/solens" target="_blank" rel="noreferrer" className="transition-colors hover:text-white" aria-label="X">
          <Icon.x className="h-[18px] w-[18px]" />
        </a>
        <a href="https://t.me/solens" target="_blank" rel="noreferrer" className="transition-colors hover:text-white" aria-label="Telegram">
          <Icon.telegram className="h-5 w-5" />
        </a>
        <a href="https://solens.app" target="_blank" rel="noreferrer" className="transition-colors hover:text-white" aria-label="Website">
